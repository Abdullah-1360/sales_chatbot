...
async function handlePasswordReset(req, res) {
  try {
    ...
    console.log(`📋 Service status: ${statusCheck.status}`);

    // Handle suspended/terminated services
...
This ticket was automatically generated by the password reset system.
      ...
      try {
        ...
        const ticketId = ticket.tid || ticket.id;
        console.log(`→ Support ticket created: ${ticketId} for suspended service`);
    ...
    // Reset password for active service
    ...
    try {
      ...
      const response = {
        ...
        message: 'Password reset completed successfully. Login credentials have been sent to your Registered email.',
        emailNotification: {
          success: true,
